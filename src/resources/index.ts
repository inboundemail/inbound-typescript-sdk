...
export { Attachments, type AttachmentRetrieveParams } from './attachments';
export {
  Domains,
...
export { Mail, type MailRetrieveResponse, type MailListResponse, type MailListParams } from './mail';
