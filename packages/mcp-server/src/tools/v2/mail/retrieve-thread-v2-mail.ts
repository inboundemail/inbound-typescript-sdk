...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/v2/mail/{id}/thread',
  operationId: 'getMailById',
};

export const tool: Tool = {
  name: 'retrieve_thread_v2_mail',
  description:
...
export const handler = async (client: Inbound, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.v2.mail.retrieveThread(id)));
};
