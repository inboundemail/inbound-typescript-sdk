...
export const metadata: Metadata = {
  ...
  operationId: 'deleteEmailsById',
};

export const tool: Tool = {
  name: 'delete_emails_v2_schedule',
  description:
...
export const handler = async (client: Inbound, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.v2.emails.schedule.delete(id)));
};
