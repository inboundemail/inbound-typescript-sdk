...
export const handler = async (client: Inbound, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.v2.domains.delete(id)));
};
